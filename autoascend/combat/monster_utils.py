...
# hypothesis: treating slow petrifying monsters as ranged-only prevents bare-handed builds from ending otherwise healthy runs on an avoidable touch attack
